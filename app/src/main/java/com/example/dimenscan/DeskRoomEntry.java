...
public class DeskRoomEntry extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desk_room_entry);
        mAuth = FirebaseAuth.getInstance();
        mUser = mAuth.getCurrentUser();
        onlineUserId = mUser.getUid();

        this.context = this;
        submit =(Button)findViewById(R.id.findDesk);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.findDesk:
                ...
                Toast.makeText(DeskRoomEntry.this,"Viewing in Room",Toast.LENGTH_LONG).show();
                break;

            case R.id.bResetBtn:
                resetDimensions();
                Toast.makeText(DeskRoomEntry.this,"Dimensions reset",Toast.LENGTH_LONG).show();
                break;
    ...
    private void searching(Context context) {
        ...
        Intent deskRoom = getIntent();
        deskWidth = deskRoom.getStringExtra("width");
        deskHeight= deskRoom.getStringExtra("depth");
        deskPrice = deskRoom.getStringExtra("price");
        deskTitle = deskRoom.getStringExtra("title");



        Intent roomEntry  = new Intent(context, ViewDesk.class);
        roomEntry.putExtra("rWidth", width);
        roomEntry.putExtra("rDepth", depth);
        roomEntry.putExtra("dWidth",deskWidth);
        roomEntry.putExtra("dHeight",deskHeight);
        roomEntry.putExtra("dPrice",deskPrice);
        roomEntry.putExtra("dTitle",deskTitle);
