...
public class DeskParseAdapter extends RecyclerView.Adapter<DeskParseAdapter.ViewHolder> {

    private ArrayList<ParseItem> parseItems;
    private Context context;

    public DeskParseAdapter(ArrayList<ParseItem> parseItems, Context context){
    ...
    @NonNull
    @Override
    public DeskParseAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.parsing_items, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DeskParseAdapter.ViewHolder holder, int position) {
